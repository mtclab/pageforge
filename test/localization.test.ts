...
const ENGLISH_LABELS = [...Object.values(PERSONAL_LABELS.en)];
...
describe('a page in a language we have no labels for tells the truth', () => {
  ...
  it('marks every English word we generated as English', () => {
    ...
    const generated = [...doc.querySelectorAll('h2, h3, [data-email-a] span')];
...
describe('label sets', () => {
  it('fi/en/sv are complete, and unknown languages fall back', () => {
    ...
    expect(personalLabels('fi-FI')).toBe(PERSONAL_LABELS.fi);
